...
function AdminLogin({ isAdminLoggedIn, onLoginSuccess, onLogout }) {
  ...
  useEffect(() => {
    document.title = "Admin Login - IRCC Client Status Management";
  }, []);
    ...
    <div className="new-application-page" style={{ maxWidth: "700px", margin: "0 auto" }}>
      <div className="section-heading">
        ...
        <p style={{ margin: "8px 0 0 0", color: "#555", fontSize: "0.95rem" }}>
          Authorized access only for IRCC administration officers.
        </p>
      </div>
      ...
      {isAdminLoggedIn ? (
        <div className="status-card" style={{ marginTop: "24px" }}>
          ...
          >
            <h2 style={{ fontSize: "1.25rem", margin: "0 0 8px 0" }}>
              Logged In as Admin
            </h2>
            <p style={{ margin: 0 }}>
          ...
          <div style={{ display: "flex", gap: "12px", marginTop: "24px", flexWrap: "wrap" }}>
            ...
            <button
              ...
              onClick={onLogout}
              style={{ backgroundColor: "#d9534f", color: "#fff", borderColor: "#d43f3a" }}
            >
              Log Out
            </button>
          </div>
